...
- The wrapper code in this repository (desktop GUI, Docker/Compose files,
  entrypoint, healthcheck, workflows, and docs) is MIT, see LICENSE. The
  vendored server keeps its own terms.
